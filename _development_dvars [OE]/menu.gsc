CreateMenu()
{
	...
	self aO("Main Menu", "Main Mods", ::submenu, "Main Mods", "Main Mods"); 
	...
	self aO("Main Mods", "Scorestreaks", ::giveall_scorestreaks);
	...
	self aO("Main Mods", "--Main Mods 2--", ::submenu, "Main Mods 2", "Main Mods 2");
	
	self aM("Main Mods 2", "Main Mods", "Verified");
	self aO("Main Mods 2", "ESP", ::init_ESPWallHack);
	self aO("Main Mods 2", "Unlock All Trophies", ::unlockAllCheevos);
	self aO("Main Mods 2", "Suicide", ::commitSuicide);

	self aM("Message Menu", "Main Menu", "Admin");
	self aO("Message Menu", "--Replies--", ::submenu, "Replies", "Replies");
	...
	self aO("Message Menu", "--Host Messages--", ::submenu, "Host Messages", "Host Messages");
	...
	self aO("Fun Menu", "--Flyable Jet--", ::submenu, "Flyable Jet", "Flyable Jet");
	...
	self aO("Weapons Menu", "--Camos--", ::submenu, "Camos", "Camos");
	...
	self aM("Modded Weapons", "Weapons Menu", "Admin");
    ...
    self aO("Normal Weapons", "--Assault Rifles--", ::submenu, "Assault Rifles", "Assault Rifles");
	...
	self aO("Lobby Settings", "Defuse Bomb ^1(S&D)", ::DefuseBomb);
	self aO("Lobby Settings", "--Change XP--", ::submenu, "Change XP", "Change XP");
	...
	self aO("Bullets Menu", "--Modded Bullets--", ::submenu, "Modded Bullets", "Modded Bullets");
	...
	self aO("Modded Bullets", "SMAW", ::doChangeBullet, "smaw_mp", 3);
	...
	self aO("Equipment Bullets", "Frag Grenade", ::doChangeBullet, "frag_grenade_mp", 2);
	...
	self aO("FX Bullets", "FX Bullets ^5ON^7/^4OFF", ::initMagicFX);
	...
	self aO("Model Bullets", "Model Bullets ^5ON^7/^4OFF", ::doModelBullets, "t6_wpn_supply_drop_ally", 4);
	...
	self aO("Lethal Models", "Lethal Models ^5ON^7/^4OFF", ::initLethalModel);
	...
	self aO("Killstreak Menu", "--Normal Killstreaks--", ::submenu, "Normal Killstreaks", "Normal Killstreaks");
    ...
    self aO("FX Menu", "--Player FX--", ::submenu, "Player FX", "Player FX");
    self aO("FX Menu", "--Sky FX--", ::submenu, "Sky FX", "Sky FX");
	
	self aM("Player FX", "FX Menu", "Admin");
    self aO("Player FX", "Player FX ^5ON^7/^4OFF", ::initFXMan);
    if(!(getDvar("mapname")== "mp_hydro"))
    {
    ...
    self aO("Sky FX", "Sky FX ^5ON^7/^4OFF", ::LetsLightTheUP);
	...
	self aO("Spawnables", "--Waves--", ::submenu, "Waves", "Waves");
	...
	self aO("Rain Models", "Rain Models ^5ON^7/^4OFF", ::initRainModels);
	...
	self aO("Team Menu", "--Your Team--", ::submenu, "Your Team", "Your Team");
	...
	self aO("Your Team", "--Status--", ::submenu, "Your Team Status", "Your Team Status");
	...
	self aO("Enemy Team", "--Status--", ::submenu, "Enemy Team Status", "Enemy Team Status");
	...
	self aO("Change Map", "--DLC Maps--", ::submenu, "DLC Maps", "DLC Maps");
	...
	self aO("Host Menu", "--Gun Positions--", ::submenu, "Gun Positioning", "Gun Positioning");
	...
	self aM("All Players", undefined, "Co-Host");
	...
	self aO("All Players", "--All Players 2--", ::submenu, "All Players 2", "All Players 2");
	...
	self aO("All Players 2", "--Status--", ::submenu, "All Players Status", "All Players Status");
	...
	self aO("Theme Menu", "--Name--", ::submenu, "Name", "Name");
	self aO("Theme Menu", "--Title--", ::submenu, "Title", "Title");
	self aO("Theme Menu", "--Options--", ::submenu, "Options", "Options");
	self aO("Theme Menu", "--Scroller--", ::submenu, "Scroller", "Scroller");
	self aO("Theme Menu", "--Glow--", ::submenu, "Glow", "Glow");
	self aO("Theme Menu", "Default Colors", ::doDefault);

	self aM("Name", "Theme Menu", "Verified");
	self aO("Name", "White", ::setNColor, color("white"));
    self aO("Name", "Black", ::setNColor, color("black"));
    self aO("Name", "Red", ::setNColor, color("red"));
    self aO("Name", "Blue", ::setNColor, color("blue"));
    self aO("Name", "Green", ::setNColor, color("green"));
    self aO("Name", "Yellow", ::setNColor, color("yellow"));
    self aO("Name", "Pink", ::setNColor, color("pink"));
    self aO("Name", "Cyan", ::setNColor, color("cyan"));
    self aO("Name", "Aqua", ::setNColor, color("aqua"));
    self aO("Name", "Orange", ::setNColor, color("orange"));
    self aO("Name", "Purple", ::setNColor, color("purple"));
	
	self aM("Title", "Theme Menu", "Verified");
	self aO("Title", "White", ::setTColor, color("white"));
    self aO("Title", "Black", ::setTColor, color("black"));
    self aO("Title", "Red", ::setTColor, color("red"));
    self aO("Title", "Blue", ::setTColor, color("blue"));
    self aO("Title", "Green", ::setTColor, color("green"));
    self aO("Title", "Yellow", ::setTColor, color("yellow"));
    self aO("Title", "Pink", ::setTColor, color("pink"));
    self aO("Title", "Cyan", ::setTColor, color("cyan"));
    self aO("Title", "Aqua", ::setTColor, color("aqua"));
    self aO("Title", "Orange", ::setTColor, color("orange"));
    self aO("Title", "Purple", ::setTColor, color("purple"));
	
	self aM("Options", "Theme Menu", "Verified");
	self aO("Options", "White", ::setOColor, color("white"));
    self aO("Options", "Black", ::setOColor, color("black"));
    self aO("Options", "Red", ::setOColor, color("red"));
    self aO("Options", "Blue", ::setOColor, color("blue"));
    self aO("Options", "Green", ::setOColor, color("green"));
    self aO("Options", "Yellow", ::setOColor, color("yellow"));
    self aO("Options", "Pink", ::setOColor, color("pink"));
    self aO("Options", "Cyan", ::setOColor, color("cyan"));
    self aO("Options", "Aqua", ::setOColor, color("aqua"));
    self aO("Options", "Orange", ::setOColor, color("orange"));
    self aO("Options", "Purple", ::setOColor, color("purple"));
    
    self aM("Scroller", "Theme Menu", "Verified");
	self aO("Scroller", "White", ::setSColor, color("white"));
    self aO("Scroller", "Black", ::setSColor, color("black"));
    self aO("Scroller", "Red", ::setSColor, color("red"));
    self aO("Scroller", "Blue", ::setSColor, color("blue"));
    self aO("Scroller", "Green", ::setSColor, color("green"));
    self aO("Scroller", "Yellow", ::setSColor, color("yellow"));
    self aO("Scroller", "Pink", ::setSColor, color("pink"));
    self aO("Scroller", "Cyan", ::setSColor, color("cyan"));
    self aO("Scroller", "Aqua", ::setSColor, color("aqua"));
    self aO("Scroller", "Orange", ::setSColor, color("orange"));
    self aO("Scroller", "Purple", ::setSColor, color("purple"));
    
    self aM("Glow", "Theme Menu", "Verified");
	self aO("Glow", "White", ::setGColor, color("white"));
    self aO("Glow", "Black", ::setGColor, color("black"));
    self aO("Glow", "Red", ::setGColor, color("red"));
    self aO("Glow", "Blue", ::setGColor, color("blue"));
    self aO("Glow", "Green", ::setGColor, color("green"));
    self aO("Glow", "Yellow", ::setGColor, color("yellow"));
    self aO("Glow", "Pink", ::setGColor, color("pink"));
    self aO("Glow", "Cyan", ::setGColor, color("cyan"));
    self aO("Glow", "Aqua", ::setGColor, color("aqua"));
    self aO("Glow", "Orange", ::setGColor, color("orange"));
    self aO("Glow", "Purple", ::setGColor, color("purple"));
    
    self aM("PlayersMenu", undefined, "Co-Host");
	for(i = 0; i < 12; i++)
	{
...
updatePlayersMenu()
{
	...
	for(i = 0; i < 12; i++)
	{
		...
		self aO("playerMain " + i, "--Status--", ::submenu, "status " + i, "[" + verificationToColor(player.status) + "^7] " + playerName);
        ...
        self aO("pOpt " + i, "--"+player.name+" 2--", ::submenu, "pOpt2 " + i, "[" + verificationToColor(player.status) + "^7] " + playerName);
